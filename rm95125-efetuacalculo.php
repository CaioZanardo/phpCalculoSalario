...
<body class="bg-secondary text-light">
  ...
  <div class="container d-flex flex-column align-items-center justify-content-center p-5">
    <form class="col-6 mb-5" method="POST">
      ...
      <div class="row mb-5">
        <label for="cert" class="form-label">Quantidade de certificações</label>
        <input type="number" class="form-control" id="cert" name="cert" value="0" min="0" />
      </div>
    ...
    <?php 
    include "rm95125-calculosalario.php";

    if (isset($_POST['salario']) && isset($_POST['dependentes']) && isset($_POST['cert'])) {
      ...
      $acrescimo = $liquido + calcularAcrescimo($cert);
      ...
      <div>
      <p>
        <strong>Salário c/ Acrescimo de Certificação:</strong>
